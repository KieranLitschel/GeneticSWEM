...
\*\*\* Accidentally did not save the notebook for this model and do not recall the exact validation accuracy, but the configuration was, for every class which had less than 20 samples in the training set, oversampled to 20 samples.
